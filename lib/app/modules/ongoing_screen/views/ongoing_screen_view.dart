...
import 'package:watchman_app/app/modules/ongoing_screen/controllers/ongoing_screen_controller.dart';
            ...
            child: StreamBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  return snapshot.data!.docs.isEmpty
                      ? Center(
                    child: Constant.showEmptyView(message: "No ongoing parking found"),
                  )
                      : ListView.builder(
                    shrinkWrap: true,
